const { botPREFIX, OWNERID } = require('../../botConfig.json');
...
module.exports = async (bot, message) => {
    ...
    if (commandfile.config.ownerOnly && !OWNERID.includes(message.author.id)) return notOwner(message, 'message.author.id');
